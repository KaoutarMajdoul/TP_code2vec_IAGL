    ...
    def predict(self):
        ...
        while True:
            ...
            for raw_prediction, method_prediction in zip(raw_prediction_results, method_prediction_results):
                ...
                for res in method_prediction.attention_paths:
                    file.write('{}\t({},{},{})\n'.format(res['score'], res['token1'],res['path'], res['token2']))
                    print('%f\tcontext: %s,%s,%s' % (res['score'], res['token1'], res['path'],res['token2']))
